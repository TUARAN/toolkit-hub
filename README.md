...
摇色子决定器是一个有趣的二选一决策工具，支持多种随机方式：

### 随机方式

1. **🎲 Math.random()** (默认)
   - 安全性: 普通
   - 原理: JavaScript内置的伪随机数生成器
   - 适用: 日常使用

2. **🔐 Crypto API**
   - 安全性: 高
   - 原理: 使用Web Crypto API生成密码学安全的随机数
   - 适用: 需要高安全性的场景
...
- **自定义选项**: 支持输入任意两个选项，或使用默认的"是/否"
- **动画效果**: 摇色子时有弹跳动画，增加趣味性
- **历史记录**: 保存最近10次选择记录，显示随机方法和具体数值
- **完整时间戳**: 显示年月日时分秒的完整时间信息
- **教育价值**: 帮助用户了解不同随机方法的原理和安全性
